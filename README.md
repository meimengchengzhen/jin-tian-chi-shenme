...
- **饮食计划**：基于 Mifflin-St Jeor 公式估算 BMR / TDEE，结合活动水平 + 目标（维持/减脂/增肌）给出每日推荐摄入；按餐次分配（默认晚餐 35%，午餐 40%，早餐 25%），推荐时与每道菜人均热量对齐。⚠️ 仅作饮食规划参考，不构成医学/营养建议。
- **环境推荐**：手动选地区（七大区）、天气（晴/雨/冷/热/潮湿/干燥）、季节（自动或覆盖）、工作日/周末。冷天加分给「暖胃 / 慢炖」，热天加分给「凉拌 / 解暑」，雨天偏「暖胃」，周末倾向稍复杂菜，工作日偏快手。
...
- **300+ 道菜谱**：手写核心菜 + 脚本扩展模板组合（主料 × 风格 × 蔬菜搭配），覆盖主菜 / 汤 / 素菜 / 主食、多菜系、多季节/天气标签。
